...
In this repository, local execution with Poetry is the primary workflow.
The Docker compose files are kept as an optional path and are not the default entrypoint.
...
If you choose to use Docker, the `docker-compose.yml` was configured to create an `IPv6` network
