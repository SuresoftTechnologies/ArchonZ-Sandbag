...
class Prot(SimpleService):
    ...
    def __init__(self, instance_id):
        ...
        self.register_method(3, self.method_hello)
        self.register_eventgroup(TimeEvgrp(self))

    def hello(self):
        return 'Hello'

    def method_hello(self, someip_message: SOMEIPHeader, addr: _T_SOCKNAME):
        msg = self.hello() + someip_message.payload.decode('ascii')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=30509)

    args = parser.parse_args()

    run_service(args.local, args.multicast, args.port)
